...
describe('[HackerNewsAPI.getArticle]', () => {
  it('gets a signle article from the HackerNewsAPI', async () => {
...
describe('[HackerNewsAPI.getAllArticles]', () => {
  it('gets an array all articles ids from the HackerNewsAPI', async () => {
    ds.getAllArticleIds = jest.fn();
    ds.getAllArticleIds.mockReturnValue(getAllArticleIdsStub);
    ds.get.mockReturnValueOnce(getArticlePreReducerStub);
